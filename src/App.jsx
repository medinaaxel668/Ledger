  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'JetBrains Mono', monospace" }}>
      <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: "16px", padding: "40px", width: "100%", maxWidth: "400px", textAlign: "center" }}>
        ...
        {!sent ? (
          <>
            <div style={{ fontSize: "12px", color: C.mutedMid, marginBottom: "20px" }}>Ingresá tu email para recibir el link de acceso</div>
            <input
            ...
            />
            {error && <div style={{ fontSize: "11px", color: C.red, marginBottom: "12px" }}>{error}</div>}
            <button onClick={handleLogin} disabled={loading || !email} style={{
              width: "100%", background: `linear-gradient(135deg,${C.accent},#c2410c)`, border: "none",
              color: C.bg, padding: "13px", borderRadius: "9px", cursor: "pointer",
              fontFamily: "inherit", fontSize: "13px", fontWeight: 700, letterSpacing: "0.08em",
          ...
          <div>
            ...
            <div style={{ fontSize: "13px", color: C.sell, fontWeight: 600, marginBottom: "8px" }}>¡Link enviado!</div>
            <div style={{ fontSize: "12px", color: C.mutedMid }}>Revisá tu email <strong style={{ color: C.text }}>{email}</strong> y hacé click en el link para entrar.</div>
          </div>
        )}
      </div>
    </div>
